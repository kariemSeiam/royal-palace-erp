...
export default function PagesStudioModuleScreen() {
  return (
    <SafeAreaView edges={["left", "right"]} style={{ flex: 1, backgroundColor: erpColors.bg }}>
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 16, paddingBottom: 140 }}>
        <View style={hero}>
          <Text style={heroTop}>PAGES STUDIO</Text>
          <Text style={heroTitle}>استوديو الصفحات</Text>
          <Text style={heroBody}>
            بداية مرنة لإدارة page blocks وتهيئة التحكم المركزي في تجربة العرض من الموبايل.
          </Text>
        </View>
        ...
        <View style={[box, { marginBottom: 12 }]}>
          ...
          <Text style={boxBody}>
            هذه الوحدة تم تأسيسها لتكون المدخل الرسمي لاحقًا لإدارة الصفحات وبلوكات layout
        ...
        <View style={box}>
          ...
          <View style={{ marginTop: 12, gap: 10 }}>
            <Bullet text="إدارة page blocks" />
            <Bullet text="إدارة layout blocks" />
            <Bullet text="ربط المحتوى بالتجربة البصرية الموحدة" />
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
