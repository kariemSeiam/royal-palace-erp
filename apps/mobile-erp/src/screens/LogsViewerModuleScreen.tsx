...
export default function LogsViewerModuleScreen() {
  return (
    <SafeAreaView edges={["left", "right"]} style={{ flex: 1, backgroundColor: erpColors.bg }}>
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 16, paddingBottom: 140 }}>
        <View style={hero}>
          <Text style={heroTop}>LOGS VIEWER</Text>
          <Text style={heroTitle}>عارض السجلات</Text>
          <Text style={heroBody}>
            صفحة الإدارة الحالية لهذه الوحدة ما زالت أولية، لذا تم تجهيزها كموديول حالة تمهيدي على الموبايل.
          </Text>
        </View>
        ...
        <View style={[box, { marginBottom: 12 }]}>
          ...
          <Text style={boxBody}>
            الربط المباشر مع log streams لم يُبنَ بعد داخل المشروع الحالي، لذلك الشاشة تعرض
            ملخص حالة فقط حتى نضيف المصدر التنفيذي لاحقًا.
          </Text>
        </View>
        ...
        <View style={box}>
          ...
          <View style={{ marginTop: 12, gap: 10 }}>
            <Bullet text="سجلات API والخدمات" />
            <Bullet text="فلاتر حسب الخدمة والتاريخ والمستوى" />
            <Bullet text="ربط بالمراقبة والتنبيهات" />
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
