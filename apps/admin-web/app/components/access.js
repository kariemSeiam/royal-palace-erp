...
const permissionAliases = {
  ...
  "bom.view": ["bom.view", "work_orders.view", "manufacturing.view"],
  "bom.manage": ["bom.manage", "work_orders.manage"],
  "routing.view": ["routing.view", "work_orders.view"],
  "routing.manage": ["routing.manage", "work_orders.manage"],
  "unbuild.view": ["unbuild.view", "work_orders.view"],
  "unbuild.manage": ["unbuild.manage", "work_orders.manage"],
...
const navTranslations = {
  ...
  "CRM + علاقات العملاء": { en: "CRM + Agents" },
  ...
  "طلبات عروض الأسعار": { en: "Requests for Quotation" },
  "المخزون": { en: "Inventory" },
  "المخزون المتقدم": { en: "Advanced Inventory" },
  "الجرد الدوري": { en: "Cycle Count" },
  "قواعد إعادة الطلب": { en: "Reorder Rules" },
  "تقييم المخزون": { en: "Stock Valuation" },
  "الباركود": { en: "Barcode" },
...
const navTree = [
  ...
  },
  {
    ...
    children: [
      ...
      { type: "item", label: "طلبات عروض الأسعار", href: "/procurement/rfqs", permissions: ["procurement.view", "procurement.manage"] },
  ...
  },
  {
    ...
    children: [
      ...
      { type: "item", label: "قواعد إعادة الطلب", href: "/reorder-rules", permissions: ["inventory.view", "inventory.manage"] },
      { type: "item", label: "تقييم المخزون", href: "/stock-valuation", permissions: ["inventory.view", "inventory.manage"] },
...
{ type: "item", label: "Bills of Materials", href: "/manufacturing/boms", permissions: ["bom.view","bom.manage"] },
{ type: "item", label: "Routings", href: "/manufacturing/routings", permissions: ["routing.view","routing.manage"] },
{ type: "item", label: "أوامر التصنيع", href: "/manufacturing/orders", permissions: ["work_orders.view","work_orders.manage"] },
{ type: "item", label: "Unbuild", href: "/manufacturing/unbuild", permissions: ["unbuild.view","unbuild.manage"] },
  ...
  {
    type: "group", key: "services", label: "CRM + علاقات العملاء", icon: "🤝",
...
const routeAccessConfig = [
  ...
  { matchers: ["/procurement/suppliers", "/procurement/purchase-orders", "/procurement/receipts", "/procurement/invoices", "/procurement/aging", "/procurement/performance", "/procurement/rfqs"], permissions: ["procurement.view", "procurement.manage"] },
  { matchers: ["/warehouses", "/inventory", "/advanced-inventory", "/inventory-adjustments", "/reorder-rules", "/stock-valuation", "/barcode", "/advanced-barcode"], permissions: ["inventory.view", "inventory.manage", "warehouses.view", "warehouses.manage", "stock.view", "stock.manage", "picking.view", "picking.manage", "barcode.view", "barcode.manage", "advanced_barcode.view", "advanced_barcode.manage"] },
  ...
  { matchers: ["/manufacturing/work-orders", "/manufacturing/mrp"], permissions: ["work_orders.view","work_orders.manage","planning.view"] },
  ...
  { matchers: ["/manufacturing/boms"], permissions: ["bom.view", "bom.manage", "work_orders.view"] },
  { matchers: ["/manufacturing/routings"], permissions: ["routing.view", "routing.manage", "work_orders.view"] },
  { matchers: ["/manufacturing/orders"], permissions: ["work_orders.view", "work_orders.manage"] },
  { matchers: ["/manufacturing/unbuild"], permissions: ["unbuild.view", "unbuild.manage", "work_orders.view"] },
